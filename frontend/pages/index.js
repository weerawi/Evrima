...
export default function Home() {
  return (
    ...
    >
      ...
      <div 
      // className="
      // relative flex place-items-center before:absolute before:h-[300px] 
      ...
      //  after:-z-20 after:h-[180px] after:w-[240px] after:translate-x-1/3 after:bg-gradient-conic
      //   after:from-sky-200 after:via-blue-200 after:blur-2xl after:content-['']
      //    before:dark:bg-gradient-to-br before:dark:from-transparent before:dark:to-blue-700/10
