...
const AboutProfile = ({image,name,position}) => {
  return (
    <div class="space-y-4 text-center">
        <Image class="w-64 h-64 mx-auto object-cover rounded-xl md:w-48 md:h-64 lg:w-64 lg:h-80 shadow-lg shadow-white transition-transform duration-300 transform-gpu hover:scale-90" 
